...
#define ZTD_PLATFORM_HAS_INCLUDE_I_(hdr) __has_include(hdr)
...
#if defined(ZTD_PLATFORM_ENCODING_C)
	#if (ZTD_PLATFORM_ENCODING_C != 0)
		#define ZTD_PLATFORM_ENCODING_C_I_ ZTD_ON
	#else
		#define ZTD_PLATFORM_ENCODING_C_I_ ZTD_OFF
	#endif
#else
	#define ZTD_PLATFORM_ENCODING_C_I_ ZTD_DEFAULT_OFF
#endif
